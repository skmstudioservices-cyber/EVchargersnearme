...
for el in els:
    ...
    f = {"type": "Feature", "geometry": {"type": "Point", "coordinates": [round(lo, 6), round(la, 6)]},
         "properties": {k: v for k, v in tags.items() if k in ["name", "operator", "brand", "opening_hours", "socket:type2", "socket:type2_combo", "socket:chademo", "socket:type1", "socket:type1_cable", "capacity", "amperage", "voltage", "fee", "authentication:app", "phone"]}}
