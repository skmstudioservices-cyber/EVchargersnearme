...
MIN_TOTAL = 200
KEEP = ["name", "operator", "brand", "opening_hours", "socket:type2", "socket:type2_combo", "socket:chademo", "socket:type1", "socket:type1_cable", "capacity", "amperage", "voltage", "fee", "authentication:app", "phone"]
